...
class DALLE3 extends Tool {
  constructor(fields = {}) {
    ...
    // DON'T add new ideas to the image given prompt instead of that detail the given prompt to enhance the image logic and quality in the descriptions after it.`;
